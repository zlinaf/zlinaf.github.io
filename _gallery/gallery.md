  ...
  <div class="glide__track" data-glide-el="track">
    <ul class="glide__slides">
      ...
      <li class="glide__slide" style="text-align:center;">
        ...
        <div style="margin-top:8px; font-size:14px; color:#333; font-weight:bold;">Group dinner at spring 2025.</div>
      </li>
      ...
      <li class="glide__slide" style="text-align:center;">
        <a href="http://zlinaf.github.io/images/photo-talk4.jpg" title="talk3">
          <img src="http://zlinaf.github.io/images/photo-talk4.jpg" style="width:100%; max-height:900px; height:auto; object-fit:contain; border-radius:4px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
        </a>
        <div style="margin-top:8px; font-size:14px; color:#333; font-weight:bold;">Research talk at CCF-DAC 2025.</div>
      </li>
      ...
      <li class="glide__slide" style="text-align:center;">
        ...
        <div style="margin-top:8px; font-size:14px; color:#333; font-weight:bold;">Sen Yan's undergraduate graduation ceremony.</div>
      </li>
      ...
      <li class="glide__slide" style="text-align:center;">
        ...
        <div style="margin-top:8px; font-size:14px; color:#333; font-weight:bold;">Binghao Cheng's undergraduate graduation ceremony.</div>
      </li>
