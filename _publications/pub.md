...
- <span style="color: #4169E1">**[CJE]**</span> Zebin Wu, **Zhe Lin**\*, Yonghong Tian. "[PowerMG: Early-stage dynamic power estimation in HLS FPGA via multi-grained GNN information](https://ieeexplore.ieee.org/document/11595422)." In *Chinese Journal of Electronics*, 2026.
...
- <span style="color: #4169E1">**[TCAD]**</span> Kai Shi, **Zhe Lin**, Xinya Luan, Jianwang Zhai, Kang Zhao. "[FVSpGEMM: A Comprehensive Framework for Exploiting Versal ACAP in High-Performance SpGEMM Acceleration](https://ieeexplore.ieee.org/abstract/document/11568823)." In *IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD)*, 2026.

<span style="font-size:24px; color:darkorange; font-weight:bold;"> 2025 </span>

- <span style="color: #4169E1">**[TCAD]**</span> Sen Yan, Kuangxun Huang, Kang Zhao, **Zhe Lin**\*. "[Accurate, Efficient and Scalable Power Modeling for FPGA HLS](https://ieeexplore.ieee.org/document/11289571)." In *IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD)*, 2025.
  
- <span style="color: #4169E1">**[ICCAD]**</span> Zefan Lin, Zedong Peng, Mingzhe Gao, Jieru Zhao\*, **Zhe Lin**\*. "[HIPPO: A Hierarchy-Preserving and Noise-Tolerant Pre-HLS Power Modeling Framework for FPGA](https://ieeexplore.ieee.org/document/11240868)." In *Proc. of IEEE/ACM International Conference on Computer-Aided Design (ICCAD)*, 2025.
...
- <span style="color: #4169E1">**[DAC]**</span> Kai Shi, **Zhe Lin**\*, Xinya Luan, Jianwang Zhai and Kang Zhao\*. "[VSpGEMM: Exploiting Versal ACAP for High-Performance SpGEMM Acceleration](https://ieeexplore.ieee.org/abstract/document/11132619)." In *Proc. of ACM/IEEE 62nd Design Automation Conference (DAC)*, 2025.

- <span style="color: #4169E1">**[DAC]**</span> Jiawei Liang, Linfeng Du, Xiaofeng Zhou, **Zhe Lin**, Jiang Xu and Wei Zhang. "[AutoClock: Automated Clock Management for Power-Efficient HLS Designs on FPGAs](https://ieeexplore.ieee.org/abstract/document/11133279/)." In *Proc. of ACM/IEEE 62nd Design Automation Conference (DAC)*, 2025.

- <span style="color: #4169E1">**[FPGA]**</span> Enlai Li, **Zhe Lin**, Sharad Sinha and Wei Zhang. "[TAPCA: An Interface-Aware Cache Management Framework for Task Partitioning on CPU-FPGA SoC Platforms](https://dl.acm.org/doi/abs/10.1145/3706628.3708824)." In *Proc. of International Symposium on Field-Programmable
Gate Arrays (FPGA)*, 2025.

<span style="font-size:24px; color:darkorange; font-weight:bold;"> 2024 </span>
...
- <span style="color: #4169E1">**[EuroSys]**</span> Yijia Zhang, Qiang Wang, **Zhe Lin**, Pengxiang Xu, Bingqiang Wang. "[Improving GPU Energy Efficiency through an Application-transparent Frequency Scaling Policy with Performance Assurance](https://dl.acm.org/doi/abs/10.1145/3627703.3629584)." In *Proc. of The 19th European Conference on Computer Systems (EuroSys)*, 2024.

<span style="font-size:24px; color:darkorange; font-weight:bold;"> 2023 and Before </span>
...
- <span style="color: #4169E1">**[ASP-DAC]**</span> **Zhe Lin**, Jieru Zhao, Sharad Sinha, Wei Zhang. "[HL-Pow: A Learning-Based Power Modeling Framework for High-Level Synthesis](http://zlinaf.github.io/files/ASPDAC20.pdf)." In *Proc. of IEEE Asia and South Pacific Design Automation Conference (ASP-DAC)*, pp. 574-580, 2020.
...
- <span style="color: #4169E1">**[KDD]**</span> Xunqiang Jiang, Tianrui Jia, Yuan Fang, Chuan Shi, **Zhe Lin**, Hui Wang. "[Pre-training on Large-Scale Heterogeneous Graph](https://dl.acm.org/doi/abs/10.1145/3447548.3467396)." In *Proc. of the 27th ACM SIGKDD Conference on Knowledge Discovery & Data Mining (KDD)*, 2021.
